...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.78292682E12, "maxY": 1.0, "series": [{"data": [[1.78292688E12, 1.0], [1.78292682E12, 1.0]], "isOverall": false, "label": "Warm Cache Group", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78292688E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 4.7142857142857135, "minX": 1.0, "maxY": 203.75, "series": [{"data": [[1.0, 13.0]], "isOverall": false, "label": "2. Stats (/api/dashboard/stats)", "isController": false}, {"data": [[1.0, 13.0]], "isOverall": false, "label": "2. Stats (/api/dashboard/stats)-Aggregated", "isController": false}, {"data": [[1.0, 11.142857142857144]], "isOverall": false, "label": "4. Students (/api/dashboard/students)", "isController": false}, {"data": [[1.0, 11.142857142857144]], "isOverall": false, "label": "4. Students (/api/dashboard/students)-Aggregated", "isController": false}, {"data": [[1.0, 203.75]], "isOverall": false, "label": "1. Auth (/api/auth/login)", "isController": false}, {"data": [[1.0, 203.75]], "isOverall": false, "label": "1. Auth (/api/auth/login)-Aggregated", "isController": false}, {"data": [[1.0, 4.7142857142857135]], "isOverall": false, "label": "3. Dosen (/api/dashboard/dosen)", "isController": false}, {"data": [[1.0, 4.7142857142857135]], "isOverall": false, "label": "3. Dosen (/api/dashboard/dosen)-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 1.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 84.58333333333333, "minX": 1.78292682E12, "maxY": 10846.333333333334, "series": [{"data": [[1.78292688E12, 10846.333333333334], [1.78292682E12, 3027.9333333333334]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.78292688E12, 293.96666666666664], [1.78292682E12, 84.58333333333333]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78292688E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 4.5, "minX": 1.78292682E12, "maxY": 209.5, "series": [{"data": [[1.78292688E12, 13.2], [1.78292682E12, 12.5]], "isOverall": false, "label": "2. Stats (/api/dashboard/stats)", "isController": false}, {"data": [[1.78292688E12, 11.333333333333332], [1.78292682E12, 10.0]], "isOverall": false, "label": "4. Students (/api/dashboard/students)", "isController": false}, {"data": [[1.78292688E12, 201.83333333333334], [1.78292682E12, 209.5]], "isOverall": false, "label": "1. Auth (/api/auth/login)", "isController": false}, {"data": [[1.78292688E12, 4.8], [1.78292682E12, 4.5]], "isOverall": false, "label": "3. Dosen (/api/dashboard/dosen)", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78292688E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 4.5, "minX": 1.78292682E12, "maxY": 207.5, "series": [{"data": [[1.78292688E12, 9.0], [1.78292682E12, 8.5]], "isOverall": false, "label": "2. Stats (/api/dashboard/stats)", "isController": false}, {"data": [[1.78292688E12, 7.166666666666667], [1.78292682E12, 6.0]], "isOverall": false, "label": "4. Students (/api/dashboard/students)", "isController": false}, {"data": [[1.78292688E12, 201.66666666666669], [1.78292682E12, 207.5]], "isOverall": false, "label": "1. Auth (/api/auth/login)", "isController": false}, {"data": [[1.78292688E12, 4.6], [1.78292682E12, 4.5]], "isOverall": false, "label": "3. Dosen (/api/dashboard/dosen)", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78292688E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.78292682E12, "maxY": 10.0, "series": [{"data": [[1.78292688E12, 0.0], [1.78292682E12, 0.0]], "isOverall": false, "label": "2. Stats (/api/dashboard/stats)", "isController": false}, {"data": [[1.78292688E12, 0.0], [1.78292682E12, 0.0]], "isOverall": false, "label": "4. Students (/api/dashboard/students)", "isController": false}, {"data": [[1.78292688E12, 0.0], [1.78292682E12, 10.0]], "isOverall": false, "label": "1. Auth (/api/auth/login)", "isController": false}, {"data": [[1.78292688E12, 0.0], [1.78292682E12, 0.0]], "isOverall": false, "label": "3. Dosen (/api/dashboard/dosen)", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78292688E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 4.0, "minX": 1.78292682E12, "maxY": 224.0, "series": [{"data": [[1.78292688E12, 222.0], [1.78292682E12, 224.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.78292688E12, 4.0], [1.78292682E12, 4.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.78292688E12, 203.9], [1.78292682E12, 224.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.78292688E12, 222.0], [1.78292682E12, 224.0]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.78292688E12, 13.0], [1.78292682E12, 12.0]], "isOverall": false, "label": "Median", "isController": false}, {"data": [[1.78292688E12, 219.59999999999997], [1.78292682E12, 224.0]], "isOverall": false, "label": "95th percentile", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78292688E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 0.11666666666666667, "minX": 1.78292682E12, "maxY": 0.36666666666666664, "series": [{"data": [[1.78292688E12, 0.36666666666666664], [1.78292682E12, 0.11666666666666667]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78292688E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 0.11666666666666667, "minX": 1.78292682E12, "maxY": 0.36666666666666664, "series": [{"data": [[1.78292688E12, 0.36666666666666664], [1.78292682E12, 0.11666666666666667]], "isOverall": false, "label": "200", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.78292688E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 0.016666666666666666, "minX": 1.78292682E12, "maxY": 0.1, "series": [{"data": [[1.78292688E12, 0.1], [1.78292682E12, 0.016666666666666666]], "isOverall": false, "label": "4. Students (/api/dashboard/students)-success", "isController": false}, {"data": [[1.78292688E12, 0.08333333333333333], [1.78292682E12, 0.03333333333333333]], "isOverall": false, "label": "3. Dosen (/api/dashboard/dosen)-success", "isController": false}, {"data": [[1.78292688E12, 0.08333333333333333], [1.78292682E12, 0.03333333333333333]], "isOverall": false, "label": "2. Stats (/api/dashboard/stats)-success", "isController": false}, {"data": [[1.78292688E12, 0.1], [1.78292682E12, 0.03333333333333333]], "isOverall": false, "label": "1. Auth (/api/auth/login)-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78292688E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 0.11666666666666667, "minX": 1.78292682E12, "maxY": 0.36666666666666664, "series": [{"data": [[1.78292688E12, 0.36666666666666664], [1.78292682E12, 0.11666666666666667]], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.78292688E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
