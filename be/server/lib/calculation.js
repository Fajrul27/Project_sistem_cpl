...
export async function calculateNilaiCpmk(mahasiswaId, cpmkId, mataKuliahId, semester, tahunAjaran) {
    try {
        ...
        const nilaiList = await Promise.all(teknikList.map(async (teknik) => {
...
export async function calculateNilaiCplFromCpmk(mahasiswaId, mataKuliahId, semester, tahunAjaran) {
    try {
